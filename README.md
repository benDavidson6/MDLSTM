...
The later tries to keep the resulting cell state bounded (if <img alt="$|c_{\text{up}}|, |c_{\text{left}}| &lt; 1 \implies |c_new| &lt; 1$" src="./svgs/0a7c5b77c6f3b358d5ac82db1bb5a752.svg" align="middle" width="224.82290819999997pt" height="24.65753399999998pt"/>).
