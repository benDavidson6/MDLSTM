...
class TrainingModel:
    ...
    def get_loss(self,):
        # todo handle multiple losses with weighting etc
    ...
    def add_optimiser(self, optimiser, vars_to_minimise=None):
        loss = self.get_loss()
        with self.graph.as_default():
            ...
            with tf.control_dependencies(update_ops):
                optimiser.minimize(loss, name=TRAIN_STEP, var_list=vars_to_minimise, global_step=global_step)
    ...
    def add_standard_loss_summaries(self):
        ...
        self.add_epoch_summaries(loss_epoch_summary)
